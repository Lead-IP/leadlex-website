    ...
    <section className="py-24 md:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          >
            B2B legal work is relationship-driven and long-cycle. Yet many firms still rely on 
            spreadsheets, inboxes, and informal tracking to manage mandates and client relationships.
          </motion.p>
        </div>
